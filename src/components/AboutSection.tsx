      ...
      <div className="container">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-square max-w-md mx-auto bg-muted rounded-2xl overflow-hidden relative">
              {/* Abstract pattern */}
          ...
          <div>
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Меня зовут <strong className="text-foreground">Жакыпбекова Ботагоз</strong>, 
